...
func onLoop() {
	...
	canvas2.Begin()
	{
		g5.Clear(0.51, 0.1, 0.1, 1.0)
		g5.DrawStringRect(str2, 10, 10, g5.ThreeOnesFloat32, g5.ThreeZeroesFloat32, 1)
	}
	canvas2.End()

	//canvas2.Paint(false, 800, 200, []float32{1,1,1,1})

	canvas2.Transfer()

	canvas.Begin()
	{
		gl3.Viewport(0,0, gl3.Sizei(canvas.Width), gl3.Sizei(canvas.Height))
		g5.Clear(0.51, 0.1, 0.51, 1.0)
		g5.DrawStringRect(str1, 10, 10, g5.ThreeOnesFloat32, g5.ThreeZeroesFloat32, 1)
		g5.DrawStringRect(str1, 30, 30, g5.ThreeOnesFloat32, g5.ThreeZeroesFloat32, 1)
		canvas2.Paint2(false, 0, 0, []float32{.5, .5, .5, .5})
	}
	canvas.End()
	canvas.Paint(false, 201, 100, []float32{1,1,1,1})
